/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 83923537b26e702af26a8e76978ef2a7)
// Runtime types generated with workerd@1.20260921.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	BROWSER: BrowserRun;
	VAULT_REPO: "rafaeldiflores/rdf-vault";
	ALLOWED_GITHUB_ID: "143029098";
	GITHUB_CLIENT_ID: string;
	GITHUB_CLIENT_SECRET: string;
	COOKIE_ENCRYPTION_KEY: string;
	VAULT_TOKEN: string;
	MCP_OBJECT: DurableObjectNamespace<import("./src/index").PostuladorMCP>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PostuladorMCP";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VAULT_REPO" | "ALLOWED_GITHUB_ID" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "COOKIE_ENCRYPTION_KEY" | "VAULT_TOKEN">> {}
}
