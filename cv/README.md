...
1. **Lint** con las reglas de la BASE: 4 secciones estándar en orden (`RESUMEN
   PROFESIONAL`, `HABILIDADES TÉCNICAS`, `EXPERIENCIA PROFESIONAL`, `EDUCACIÓN Y
   CERTIFICACIONES`), título profesional literal (`titulo_profesional` del
   encabezado; rechaza variantes como "Informático" o sin tilde), fechas con mes y
   año en una línea, fechas fijas (MAZA = May 2024…), textos vetados
   (`nunca_incluir`), sin `ESTIMADA`, sin fechas de verificación, sin
   `[[marcadores]]`, sin "C1"; aviso sobre 8 viñetas de experiencia.
